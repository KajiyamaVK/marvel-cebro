...
_Esse projeto visa a criação de uma pesquisa dos personagens da Marvel usando a [Marvel API](developer.marvel.com). A aplicação também está online na **[Vercel](app.marvel-cebro.com)**_
...
- Aplicação se encontra online na **[Vercel](app.marvel-cebro.com)**.
